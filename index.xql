...
declare function idx:get-metadata($root as element(), $field as xs:string) {
    ...
    return
        switch ($field)
            ...
            case "date" return $header//tei:origDate/@from
            case "startDate" return $header//tei:origDate/@from
            case "endDate" return $header//tei:origDate/@to
            case "genre" return $root/id('genre')/tei:catDesc
