...
import module namespace ridx="http://tei-publisher.com/jinks/registers/index" at "../registers-static-index.xql";

 

import module namespace timeline="http://teipublisher.com/api/timeline" at "../timeline-api.xql";
