...
import module namespace pm-about-web="http://www.tei-c.org/pm/models/about/web/module" at "../transform/about-web-module.xql";
...
declare variable $pm-config:web-transform := function($xml as node()*, $parameters as map(*)?, $odd as xs:string?) {
    switch ($odd)
    case "about.odd" return pm-about-web:transform($xml, $parameters)
...
case "teipublisher.odd" return pm-teipublisher-web:transform($xml, $parameters)
    default return pm-moore-web:transform($xml, $parameters)
...
case "teipublisher.odd" return pm-teipublisher-print:transform($xml, $parameters)
    default return pm-moore-print:transform($xml, $parameters)
...
case "teipublisher.odd" return pm-teipublisher-fo:transform($xml, $parameters)
    default return pm-moore-fo:transform($xml, $parameters)
...
case "teipublisher.odd" return pm-teipublisher-latex:transform($xml, $parameters)
    default return pm-moore-latex:transform($xml, $parameters)
...
case "teipublisher.odd" return pm-teipublisher-epub:transform($xml, $parameters)
    default return pm-moore-epub:transform($xml, $parameters)
